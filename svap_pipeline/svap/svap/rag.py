...
class DocumentIngester:
    ...
    def ingest_file(self, filepath: str, doc_type: str = "other", metadata: dict = None):
    ...
    def ingest_text(self, text: str, filename: str, doc_type: str = "other", metadata: dict = None):
...
class ContextAssembler:
    ...
    def retrieve(self, query: str, doc_type: str = None, max_chunks: int = None) -> str:
